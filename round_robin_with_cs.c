// Round robin scheduling algorithm for n processes with context switch overhead
#include <stdio.h>
#include <stdlib.h>
#include <math.h>
#include <string.h>
...
void round_robin(int n, int time_quantum, int context_switch_overhead)
{
	...
	{
		int index = dequeue();
		// If context swith occurs then add context switch overhead
		if (prev_process_index != index && prev_process_index != -1)
		{
